        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <Link href="https://forms.gle/Q5MNwfZbwDNQUQBX6" className="font-semibold text-green-600">
                <span aria-hidden="true" className="absolute inset-0" />
                Join us today for free <span aria-hidden="true">&rarr;</span>
              </Link>
            </div>
          </div>
          <div className="text-center">
            <h4 className="text-4xl font-bold tracking-tight text-green-600 sm:text-6xl">
              List your service today.
            </h4>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            You can reach them by listing your services on our platform. Click on Get started below to have your business listed.
            </p>
